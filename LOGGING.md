...
format and context of the traces for you. Take a look at [logger.js](https://github.com/Global-Mapping-Hub/CartoDB-SQL-API/blob/b28835ff56a4b3a98e5273d192d48a81974f5a14/lib/utils/logger.js)
(NOTE: that file will be moved soon to a common module).

The logger is instantiated as part of the [server startup process](https://github.com/Global-Mapping-Hub/CartoDB-SQL-API/blob/b28835ff56a4b3a98e5273d192d48a81974f5a14/lib/server.js#L17),
